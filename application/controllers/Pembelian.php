...
public function tambah_spk($id_lsp = NULL){
	...
	//	if($this->m_pembelian->save_purchase_hd($data_hd) && $this->m_pembelian->save_purchase_dt1($data_detail_keluar)){
		...
		//}
			...
			redirect('pembelian/list_pesanan_pembelian'); //redirect page
		}
 ...
 public function kelengkapan_pr($id_pr = NULL){
	...
	//	$url_cetak = 'pembelian/export_excel_01?filter=1&project='.$project;
		...
		$this->load->view('pembelian/laporan01', $this->data);
	}
	...
	//	$url_cetak = 'pembelian/export_excel_01?filter=1&project='.$project;
		$url_cetak = 'pembelian/export_excel_laporan_bydate?filter=1&tanggal='.$tanggal.'&dan_tanggal='.$dan_tanggal;
	 	$this->data['url_cetak_excel'] = base_url($url_cetak);

		$this->load->view('pembelian/laporan_detail_item_bydate', $this->data);
	}
	...
	// 	$url_cetak_excel = 'penerimaan/export_excel_01?filter=1&tanggal='.$tanggal.'&dan_tanggal='.$dan_tanggal.'&supplier='.$supplier;
      ...
      //  $this->data['url_cetak'] = base_url($url_cetak);
        ...
        $this->data['grand_total'] = $this->m_pembelian->laporan_01_total_grand_report_bydate($tanggal,$dan_tanggal);
  		$this->load->view('pembelian/laporan_excel_01_dtitem_bydate', $this->data);
    }
	...
	//	$url_cetak = 'pembelian/export_excel_01?filter=1&project='.$project;
		$url_cetak = 'pembelian/export_excel_01_dt_item?filter=1&project='.$project;
	 	$this->data['url_cetak_excel'] = base_url($url_cetak);

		$this->load->view('pembelian/laporan_detail_item', $this->data);
	}
	...
	// 	$url_cetak_excel = 'penerimaan/export_excel_01?filter=1&tanggal='.$tanggal.'&dan_tanggal='.$dan_tanggal.'&supplier='.$supplier;
      ...
      //  $this->data['url_cetak'] = base_url($url_cetak);
        $this->data['mdl'] = $penerimaan;
        $this->data['grand_total'] = $this->m_pembelian->laporan_01_total_grand_report($project);
  		$this->load->view('/pembelian/laporan_excel_01_dtitem', $this->data);
    }
	...
	// 	$url_cetak_excel = 'penerimaan/export_excel_01?filter=1&tanggal='.$tanggal.'&dan_tanggal='.$dan_tanggal.'&supplier='.$supplier;
      ...
      //  $this->data['url_cetak'] = base_url($url_cetak);
        $this->data['mdl'] = $penerimaan;
        $this->data['grand_total'] = $this->m_pembelian->laporan_01_total_grand_report($project);
  		$this->load->view('/pembelian/laporan_excel_01', $this->data);
    }
	...
	//	$dompdf = new Dompdf();
		...
		$html = $this->load->view('pembelian/report_pembelian01', $this->data, true);
	...
	//	$dompdf = new Dompdf();
		...
		$html = $this->load->view('pembelian/report_pembelian03', $this->data, true);
		$this->pdf->create($html, $filename);
	}
	...
	//	$dompdf = new Dompdf();
		...
		$html = $this->load->view('pembelian/report_pembelian04', $this->data, true);
		$this->pdf->create($html, $filename);
	}
	...
	//	$dompdf = new Dompdf();
		...
		$html = $this->load->view('pembelian/report_pembelian02', $this->data, true);
		$this->pdf->create($html, $filename);
	}
	...
	//	$dompdf = new Dompdf();
		...
		$html = $this->load->view('pembelian/report_permintaan01', $this->data, true);
		$this->pdf->create($html, $filename);
	}
	...
	public function move_pr(){
		...
		redirect('pembelian/list_permintaan');
	}
	...
	public function list_selesai_item($id_lsp = NULL){
	  ...
	  public  function data_pembelian_spk(){
		...
		$this->load->view('pembelian/list_spk_selesai', $this->data);
	}
 	...
 	$this->data['hd_api'] = $this->m_pembelian->api_show($id_pr);
		...
		//$this->data['all_Mom'] = $this->m_mom->lihat();
	    	...
	    	$this->data['proyek'] = $this->m_pembelian->daftar_project();
				...
				$this->load->view('pembelian/detail_po_dt_log', $this->data);
			}
	...
	public function ubah_po_Hd(){
     ...
     //   exit;
			...
			redirect('pembelian/kelengkapan_pr/'.$id_hd);
			}
  ...
  $no = $this->input->post('no'); //array of id
    ...
    $data_detail['status_item_noted'] = $status_item_noted;
     ...
     //   exit;
		...
		redirect('pembelian/list_pengiriman');
  ...
  //      print_r ($_POST);
   //     echo '</pre>';
	...
	public function finish($id_lsp = NULL){
		...
		$this->load->view('paym/lihat_paym_apprvd', $this->data);
	}
	...
	//   $header_payment = $this->input->post('header_payment');
      ...
      public function print_p($id_lsp = NULL){
		...
		$url_cetak = 'payment/export_p?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
		$url_cetak_excel = 'payment/export_excel_pending?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
		$this->data['url_cetak'] = base_url($url_cetak);
		$this->data['url_cetak_excel'] = base_url($url_cetak_excel);
		$this->data['all_paym'] = $absensi;
		$this->data['count'] = $count;
	...
	//   $header_payment = $this->input->post('header_payment');
       ...
       // $kalimat2=addcslashes($nama_fle);
      	$ket = $nama_fle.date('dmY', strtotime($tanggal));
      	$url_cetak = 'payment/export_excel_pending?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
      	$url_cetak_excel = 'payment/export_excel_pending?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
      	$absensi = $this->m_payment->view_payment_status_pp($tanggal,$header_payment);  
      	$count = $this->m_payment->view_payment_status_fffp($tanggal,$header_payment);
      	$this->data['ket'] = $ket;
      ...
      public function print_paid($id_lsp = NULL){
		...
		$url_cetak = 'payment/export_paid?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
		$url_cetak_excel = 'payment/export_excel_paid?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
		$this->data['url_cetak'] = base_url($url_cetak);
		$this->data['url_cetak_excel'] = base_url($url_cetak_excel);
		$this->data['all_paym'] = $absensi;
		$this->data['count'] = $count;
	...
	//   $header_payment = $this->input->post('header_payment');
      	$ket = 'LAPORAN PAYMENT '.$header_payment.' TANGGAL '.date('d-m-Y', strtotime($tanggal));
      	$url_cetak = 'payment/export_excel_paid?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
      	$url_cetak_excel = 'payment/export_excel_paid?filter=1&tanggal='.$tanggal.'&header_payment='.$header_payment;
      	$absensi = $this->m_payment->view_payment_status_ppaid($tanggal,$header_payment);  
      	$count = $this->m_payment->view_payment_status_paid($tanggal,$header_payment);
      	$this->data['ket'] = $ket;
  ...
  //  $url = 'http://example.com/api/data?page='.$page.'&limit='.$limit;
    ...
    $data_res = json_decode($response,true);
       ...
       // $this->load->view('data_view', $data);
        $this->load->view('pembelian/v_api', $data);
    }
...
public function view_api5()
{
    ...
    $config['base_url'] = base_url() . 'pembelian/getDataFromAPI';
...
private function getTotalRows()
{
   ...
   // $url = 'https://contohapi.com/count';
	...
	$this->load->view('pembelian/v_api', $this->data);
}
	...
	//	$url_cetak = 'pembelian/export_excel_01?filter=1&project='.$project;
		...
		$this->load->view('pembelian/laporan03', $this->data);
	}
	...
	//	$url_cetak = 'pembelian/export_excel_01?filter=1&project='.$project;
		...
		$this->load->view('pembelian/laporan02', $this->data);
	}
	...
	//	$url_cetak = 'pembelian/export_excel_01?filter=1&project='.$project;
		...
		$this->load->view('pembelian/sub_laporan', $this->data);
	}
	...
	// 	$url_cetak_excel = 'penerimaan/export_excel_01?filter=1&tanggal='.$tanggal.'&dan_tanggal='.$dan_tanggal.'&supplier='.$supplier;
      ...
      //  $this->data['url_cetak'] = base_url($url_cetak);
        $this->data['mdl'] = $penerimaan;
        $this->data['grand_total'] = $this->m_pembelian->laporan_01_total_grand_furniture($id_lsp,$jenis);
  		$this->load->view('pembelian/laporan_sub', $this->data);
    }
