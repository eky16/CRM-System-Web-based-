    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" data-url="<?= base_url('mom/lihat_semua') ?>">
                ...
                <hr>
                    <form action="<?= base_url('karyawan/proses_tambah') ?>" enctype="multipart/form-data" id="form-tambah" method="POST" onsubmit="return validation(this)">
                    <!-- Content Row -->
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Data User </h4>
                                  <div class="form-group col-md-12">
                                            <label for="nama_barang"><strong>Nama </strong></label>
                                             <input onkeyup="this.value = this.value.toUpperCase()" type="text" maxlength="50" name="nama_karyawan" placeholder="Masukkan Nama Lengkap" autocomplete="off" value=""  class="form-control" autofocus="autofocus">
                                        </div>
                            ...
                            ?>>PEREMPUAN</option>
                                        ...
                                        <input type="date" placeholder="yyyy-mm-dd"  name="ulang_tahun" value=""  class="form-control">
                                        </div>
                                <div class="form-group col-12">
...
<div id="inputFormRow">
    <div class="input-group mb-2">
        <input type="text" readonly name="EmployeeID" 
               value="<?php echo sprintf('%03d', $kode_nik) ; ?>" 
               class="form-control m-input" autocomplete="off">

        <input type="text" readonly name="buntut_nik" 
               class="form-control m-input" placeholder="mmyy" 
               autocomplete="off" value="<?php echo date('my'); ?>" required maxlength="4">
    </div>
</div>
                 </div>
         <div class="form-group col-12">   
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="username" class="form-control m-input" placeholder="username untuk login" autocomplete="off" required >
                        ...
                        <!--        <div class="form-group col-12">
                                        ...
                                        <input type="text" placeholder="yyyy-mm-dd" id="datepicker_2" name="tgl_bergabung" value=""  class="form-control" required>
                                        </div>
                                <div class="form-group col-12">
                                            <label>Status</label>
            ...
            <select id="select-state" placeholder="Atasan" name="supervisorID" class="form-control" required>           
