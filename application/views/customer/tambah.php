				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('customer/proses_tambah') ?>"  id="from1" name="form" method="POST">
								...
								<div class="form-row">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="no_tlp_cst" placeholder="Masukkan No Tlp" autocomplete="off" maxlength="50"  class="form-control" >
										</div>
										<div class="form-group col-6">
