...
<?php
    ...
    ?>
				...
				<div class="card shadow">
					<div class="card-header"><strong><?= $title ?> - <?= $hd_pr->created_po ?>, <?= $hd_pr->createdtime_po ?></strong>
                        ...
                        <?php endif ;?> 
					      	...
					      	<div class="dropdown-menu">&nbsp;&nbsp;&nbsp;
					      		<a href="<?= base_url('pembelian/export_pesanan_pembelian01/'. $hd_pr->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp; CSA</a>
					      		<a href="<?= base_url('pembelian/export_pesanan_pembelian02/'. $hd_pr->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp; MSA</a>
					      		<a href="<?= base_url('pembelian/export_pesanan_pembelian03/'. $hd_pr->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;SPK CSA</a>
					      		<a href="<?= base_url('pembelian/export_pesanan_pembelian04/'. $hd_pr->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;SPK MSA</a>
					      	</div>
					...
					<a href="<?= base_url('pembelian/list_pengiriman') ?>" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;List Pengiriman </a>
					<?php endif;?>
				<?php if($hd_pr->status_po == 9):?>
					<a href="<?= base_url('pembelian/list_klaim') ?>" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;List Komplain </a>
				<?php endif;?>
				<?php if($hd_pr->status_po == 7):?>
					<a href="<?= base_url('pembelian/list_selesai') ?>" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;List Pesanan Pembelian Selesai </a>
				<?php endif;?>
				 <?php if($emp->department == 'PPIC' OR  $emp->department == 'IT'):?>
...
<form action="<?= base_url('pembelian/ubah_po_Hd_back') ?>" enctype="multipart/form-data" name="form" id="from2" method="POST">
...
<?php if (!empty($hs_header)):?>
    ...
    <a href="<?= base_url('pembelian/detail_po_dt_log/' . $hd_pr->id ) ?>" target="_blank" class="btn btn-outline-info btn-sm" style="color:black"> Riwayat Perubahan Data Header</a>
<?php endif;?>
<?php if (empty($hs_header)):?>
										...
										<?php foreach ($dt_pr as $row): ?>
											<tr>
                                                ...
                                                <?php if(!empty($row->id_rap)):?>
                                                    ...
                                                    <a target="_blank" href="<?php echo base_url('leads/rab/'.$hd_pr->projectNo) ?>"><?= $row->id_rap ?> </a>
                                                <?php endif;?>
                                                </td>
...
<form action="<?= base_url('pembelian/proses_klaim_po') ?>" enctype="multipart/form-data"   method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
	...
	<?php foreach ($dt_pr_count_estimator as $row): ?>
			...
			<?php else: ?>
				...
				<?php endforeach ?>
									...
									<form action="<?= base_url('pembelian/finish_pesanan_pembelian') ?>" enctype="multipart/form-data" id="from_finish" method="POST">
							       <div class="form-group col-12">
...
<form action="<?= base_url('pembelian/proses_pengiriman_ulang') ?>" enctype="multipart/form-data"   method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
...
<form action="<?= base_url('pembelian/proses_approve_po') ?>" enctype="multipart/form-data" id="from1" method="POST">
	...
	<?php endif;?>
	 ...
	 <a  onclick="return confirm('Lanjut ?')" href="<?= base_url('pembelian/kelengkapan_pr/' . $hd_pr->id ) ?>"  class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp;&nbsp;Lengkapi Data PR</a>
	<?php endif;?> 	
 </form>
</div>
 </div>
