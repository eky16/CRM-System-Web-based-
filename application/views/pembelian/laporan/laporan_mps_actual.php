 ...
 <tbody>
  <?php $i=1;
    ...
    <tr>
                ...
                <td class="text"><?php echo $row->timescan_cutting; ?></td>
                <td class="text"><?php echo $row->timescan_punching; ?></td>
                <td class="text"><?php echo $row->timescan_bending; ?></td>
                <td class="text"><?php echo $row->timescan_welding; ?></td>
                <td class="text"><?php echo $row->timescan_ps; ?></td>
                <td class="text"><?php echo $row->timescan_fa; ?></td>
                <td class="text"><?php echo $row->timescan_packing; ?></td>             
