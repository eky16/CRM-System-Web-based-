			...
			<div id="content" data-url="<?= base_url('pengeluaran') ?>">
				...
				<div class="card shadow">
					<div class="card-header"><strong><?= $title ?> - <?= $hd_pr->created_po ?>, <?= $hd_pr->createdtime_po ?></strong>
					      <div class="float-right">
				<a href="<?= base_url('wo/export_pesanan_permintaan01/'. $hd_pr->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak Pdf </a>
					<a href="<?= base_url('wo/list_permintaan') ?>" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;List Permintaan </a>
...
<form action="<?= base_url('wo/ubah_pr_dt') ?>" enctype="multipart/form-data" id="from2" method="POST">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="form-group col-md-12">
                                <label for="nama_barang"><span class="badge badge-success">Nama Barang </span></label>
                                             <input  type="text" maxlength="50"  name="detailName" placeholder="Masukkan Nama Lengkap" autocomplete="off" value="<?php echo $row->detailName; ?>" readonly class="form-control">
                                </div>
                            <div class="form-group col-md-12">
                                <label for="nama_barang"><span class="badge badge-success">Warna </span></label>
                                   <input  type="text" maxlength="50"  name="warna" placeholder="Warna" autocomplete="off" value="<?php echo $row->warna; ?>"  class="form-control" readonly>
                                </div>
                                <div class="form-group col-md-12">
                                            <label for="nama_barang"> <span class="badge badge-success">Jumlah</span></label>
                                             <input  type="number" maxlength="50"  name="quantity" placeholder="Masukkan Jumlah " autocomplete="off" value="<?php echo $row->quantity; ?>"  class="form-control" >
                                </div>
                                <div class="form-group col-md-12">
...
<form action="<?= base_url('wo/ubah_pr_customer') ?>" enctype="multipart/form-data" id="from2" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
...
<form action="<?= base_url('wo/proses_approve_pr') ?>" enctype="multipart/form-data" id="from1" method="POST">
	...
	<?php  	$cek_jabatan 	= $emp->divisi.' '.$emp->department;
	 ...
	 <?php if($cek_jabatan == 'Staff PPIC' OR $cek_jabatan == 'Staff IT' and $cek_status_pr == 1):?>
	...
	<?php endif;?>
    	<?php if($cek_jabatan == 'Staff PPIC' OR $cek_jabatan == 'Staff IT' and $cek_status_pr == 2):?>
	 <a  onclick="return confirm('Lanjut ?')" href="<?= base_url('wo/kelengkapan_pr/' . $hd_pr->id ) ?>"  class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp;&nbsp;Lengkapi Data </a>
	<?php endif;?> 	
 </form>
</div>
 </div>
