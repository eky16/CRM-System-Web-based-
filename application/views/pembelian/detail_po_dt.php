        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" data-url="<?= base_url('pengeluaran') ?>">
                ...
                <div class="card shadow">
                  ...
                  <!--  <a href="<?= base_url('pembelian/list_pesanan_pembelian') ?>" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;List Produksi </a> -->
...
<form action="<?= base_url('pembelian/ubah_po_Hd') ?>" enctype="multipart/form-data" id="from2" method="POST">
...
<div  class="modal modal-right fade" id="modal_update_dt<?php echo $row->no; ?>" tabindex="-1" role="dialog" aria-labelledby="right_modal">
  ...
  <form action="<?= base_url('pembelian/ubah_po_dtt') ?>" enctype="multipart/form-data"  method="POST" role="form" id="newModalForm"> 
...
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>pembelian/delete_detail_p0",
    method:"POST",
