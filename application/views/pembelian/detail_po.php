		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('pengeluaran') ?>">
               ...
               <?php if($hd_pr->status_po != 7 and $cek_pembuat_po == $cek_session):?>     
                <table class="table table-borderless">
                  <form action="<?= base_url('pembelian/proses_terima_barang') ?>"  enctype="multipart/form-data" id="aksi_terima" method="POST">
                  <tr>
                ...
                <table class="table table-borderless">
                  <form action="<?= base_url('pembelian/proses_return_barang') ?>"  enctype="multipart/form-data" id="aksi_terima" method="POST">
                  <tr>
                    <td width="100"><strong> Status Barang </strong></td>
                    <td width="1">:</td>
...
<form action="<?= base_url('pembelian/ubah_po_dt') ?>" enctype="multipart/form-data" id="from2" method="POST">
...
<form action="<?= base_url('pembelian/proses_approve_pr') ?>" enctype="multipart/form-data" id="from1" method="POST">
