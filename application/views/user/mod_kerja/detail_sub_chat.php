					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-6">
                                ...
                                <a href="<?php echo base_url('user/mod_kerja/detail_kontribut/'.$kode_modul)?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
                  <a  href="<?php echo base_url('user/dashboard')?>" class="btn btn-primary btn-sm"><i class="fa fa-home"></i>&nbsp;&nbsp;Dashboard</a>
...
?>">                                      
 <input type="" hidden name="kode_modul"  value="<?php echo $kode_modul ?>">
                                        ...
                                        <div class="form-group col-md-12">
                                       <?php if($this->session->login['nama'] != $penerima ): ?>     
