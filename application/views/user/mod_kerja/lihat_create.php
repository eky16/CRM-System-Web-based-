            ...
            <div id="content" data-url="<?= base_url('asst') ?>">
                ...
                <div class="container-fluid">
                    ...
                    <div class="float-right"> 
                      <!--      <a href="<?= base_url('user/mod_kerja/ubah_proses/' .basename($_SERVER['REQUEST_URI'], '?' . $_SERVER['QUERY_STRING'])) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit">&nbsp;&nbsp;Edit</i></a> -->
                            <a href="<?= base_url('user/mod_kerja/detail/'.basename($_SERVER['REQUEST_URI'], '?' . $_SERVER['QUERY_STRING'])) ?>" class="btn btn-info btn-sm"><i class="fa fa-refresh "></i>&nbsp;&nbsp;Refres</a>
                             <a href="<?= base_url('user/mod_kerja/lihat_semua/') ?>" class="btn btn-primary btn-sm"><i class="fa fa-home "></i>&nbsp;&nbsp;Home</a>  
                    ...
                    <div class="table-responsive">
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                <!--    <td align="center"><a target="blank" href="<?= base_url('user/mod_kerja/detail_sub/' . $v_department->id_sub) ?>" class="btn btn-primary btn-sm">Lihat </a></td> -->
                                    <td>
                                  <?php $cek_penerima =  $v_department->nama_karyawan; ?>
                                  <?php if ($cek_penerima == $this->session->login['nama']):?>
                                    <a  data-toggle="modal" style="color:white" data-target="#right_modal_update<?= $v_department->id_sub ?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"> Edit</i></a><?php else:?> <button disabled class="btn btn-info btn-sm"><i class="fa fa-pencil"> Edit</i></button> <?php endif;?></td>
                                    </tr>
<div  class="modal modal-right fade" id="right_modal_update<?= $v_department->id_sub ?>" tabindex="-1" role="dialog" aria-labelledby="right_modal">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit Progress Task</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
<form action="<?= base_url('user/mod_kerja/update_task_progress') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                           ...
                                           <input type="text" hidden name="id_sub"  value="<?= $v_department->id_sub ?>">
                                         <input type="text" hidden name="kode_create"  value="<?= $v_department->kode_create ?>">
          
                                <div class="form-group col-md-12">
                                            <label for="nama_barang">Deskripsi </label>
                                            <textarea class="form-control"  name="deskripsi_detail_sub"><?= $v_department->tugas ?> </textarea>
                                </div>
                                                                <div class="form-group col-md-12">
                                            <label for="nama_barang">Status : </label>
 <div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="status_tugas" value="1" <?php if($v_department->status_tugas == '1'){echo 'checked';}?>>Menunggu
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="status_tugas" value="2" <?php if($v_department->status_tugas == '2'){echo 'checked';}?>>Proses
  </label>
</div>
<div class="form-check-inline disabled">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="status_tugas" value="3" <?php if($v_department->status_tugas == '3'){echo 'checked';}?>>Selesai
  </label>
</div> 

                                </div>
                                <div class="form-group col-md-12">
                                            <label for=""><strong>Foto </strong>  <i> <font size="2px" color="red">Upload Jika Task sudah selesai</font></i></label>
...
<?php endif; ?></font></td>
 <td><font size="2px"><a  href="<?= base_url('user/mod_kerja/detail_sub/' . $row->kode_create) ?>" target="blank"  class="btn btn-primary btn-sm"><i class="fa fa-envelope"><?php if(!empty($row->read_message OR $row->read_message2)):?><span class="badge badge-danger badge-counter">*</span><?php endif;?>Message</i></a></font></td>
...
<form action="<?= base_url('user/upload/update_berkas_detail_sub_creat') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                           <input type="text" hidden name="kode_modul"  value="<?= basename($_SERVER['REQUEST_URI'], '?' . $_SERVER['QUERY_STRING']); ?>">
                   ...
                   <div class="form-group col-md-12">
                                        ...
                                        echo date('Y-m-d ');
                                        ?>"  class="form-control">
                                        <input  type="text" maxlength="50" name="status_task_sub" placeholder="Judul" autocomplete="off" value="<?= $row->status_task_sub ?>"  class="form-control" required>
                                  ...
                                  <tbody> 
                                    ...
                                    <tr>
                                        <td  width="50" style="font-size: 12px">
                                         ...
                                         <td style="font-size: 12px"><?php echo $info_modul->createdby ?></td>
...
<p style="font-size: 9px"><i> (<?php echo $info_modul->department ?>)</i></p>
                                        ...
                                        <td style="font-size: 12px"><?php echo $info_modul->nama_proyek ?>              <?php 
                                       $persentasi=round($info_modul->proses/$info_modul->progres * 100,2); 
                                        ...
                                        <td style="font-size: 12px">
                                         ...
                                         <p>Response : <?php if($info_modul->tgl_proses != '0000-00-00 00:00:00') : ?>     
                                            ...
                                            echo " " . $d . "d " . $h . "h " . $i . "m";
                                            ?>  <?php endif; ?></p>
                                         <p>Process :   <?php if($info_modul->tgl_proses != '0000-00-00 00:00:00' and $persentasi != '100') : ?>     
                                            <?php 
                                            date_default_timezone_set('Asia/Jakarta');
...
<form method="post" action="<?= base_url('user/upload/save_berkas_detail_sub_creat') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
      <div class="modal-body">
                                 <!-- Content Column -->
                            ...
                            <div class="card shadow mb-4">
                             ...
                             <div class="form-group col-md-12">
                                       <?php if($this->session->login['nama'] == $info_modul->nama_karyawan ): ?>     
                                             <textarea class="form-control" hidden  name="kepada"  placeholder="Enter message..." ><?= $info_modul->createdby;?></textarea>
                                        <?php else: ?>
...
<div id="berkas_tambah" class="modal fade">
 ...
 <form method="post" action="<?= base_url('mod_kerja/save_berkas_user_creat') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
        <div class="modal-body">
                                 <!-- Content Column -->
                        <div class="col-lg-12 mb-4">
    ...
    setInterval(function(){
      ...
      //  $('#mydata').dataTable();
        ...
        function tampil_data_barang(){
            ...
            $.ajax({
                type  : 'post',
                url   : '<?php echo base_url()?>user/mod_kerja/data_barang',
...
$(document).ready(function(){
  ...
  $.ajax({
      url: '<?php echo base_url()?>user/mod_kerja/saved',
      type: 'POST',
      data : input,
      dataType : 'JSON',
      success:function(data){
...
//var input = new input_file($('form')[0]);
  $.ajax({
      url: '<?php echo base_url()?>user/mod_kerja/saved_kontributor',
      type: 'POST',
      data : input,
      dataType : 'JSON',
      success:function(data){
