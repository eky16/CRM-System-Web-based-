...
<div class="form-group col-md-12">
   <?php if($this->session->login['nama'] != $info_modul->nama_karyawan ): ?>     
     <textarea class="form-control" hidden  name="kepada3"  placeholder="Enter message..." ><?= $info_modul->nama_karyawan;?></textarea>
 <?php endif;?>
...
<div  class="modal modal-right fade" id="detail_task_file<?= $row->kode_create; ?>" tabindex="-1" role="dialog" aria-labelledby="right_modal">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
     ...
     <form method="post" action="<?= base_url('user/upload/save_berkas_dt_tsk_kontribut') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
        <div class="modal-body">
           <!-- Content Column -->
           <div class="col-lg-12 mb-4">
...
<form method="post" action="<?= base_url('user/upload/save_berkas_detail_sub_kontribut') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
      <div class="modal-body">
                                 <!-- Content Column -->
...
<div id="berkas_tambah" class="modal fade">
 ...
 <form method="post" action="<?= base_url('mod_kerja/save_berkas_user_kontribut') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
        <div class="modal-body">
                                 <!-- Content Column -->
                        <div class="col-lg-12 mb-4">
