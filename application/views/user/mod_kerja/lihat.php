...
<div  class="modal modal-right fade" id="detail_task_file<?= $row->kode_create; ?>" tabindex="-1" role="dialog" aria-labelledby="right_modal">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
     ...
     <form method="post" action="<?= base_url('user/upload/save_berkas_dt_tsk') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
        <div class="modal-body">
           <!-- Content Column -->
           <div class="col-lg-12 mb-4">
...
<form method="post" action="<?= base_url('user/upload/save_berkas_detail_sub') ?>" enctype="multipart/form-data" class="form-horizontal" id="form-tambah">  
      <div class="modal-body">
                                 <!-- Content Column -->
