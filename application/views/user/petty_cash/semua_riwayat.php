...
<body id="page-top">
                          ...
                          <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="h6 mb-0  font-weight-bold text-success text-uppercase mb-1"> <a  href="#">SALDO PETTY CASH</a></div>
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                          <div class="card border-left-warning shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="h6 mb-0  font-weight-bold text-warning text-uppercase mb-1"> <a  href="#">TOTAL SALDO MASUK</a></div>
                                  <div class="h3 mb-0 font-weight-bold text-gray-800"> <?php if(!empty($petty_cash->saldo)): ?>
					  	<?php $hasil_rupiah = "Rp " . number_format($sum_isi_ulang->total_isi_ulang,2,',','.');
                        echo $hasil_rupiah; ?><?php else: ?>
                        <?php $hasil_rupiah = "Rp " . number_format('0',2,',','.');
                        echo $hasil_rupiah; ?>	
                        <?php endif;?></div>
                                ...
                                <div class="col-auto">
                                <a href="#">   <i class="fa fa-money fa-2x text-gray-000"></i>  <i class=" fa fa-arrow-circle-down fa-2x text-gray-000" style="color:green;"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
                       ...
                       <div class="col-xl-6 col-md-6 mb-4">
                          <div class="card border-left-danger shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="h6 mb-0  font-weight-bold text-danger text-uppercase mb-1"> <a  href="#">TOTAL SALDO KELUAR</a></div>
                                  <div class="h3 mb-0 font-weight-bold text-gray-800"> 
                        <?php if(!empty($petty_cash->saldo)): ?>
					  	<?php $hasil_rupiah = "Rp " . number_format($sum_saldo_keluar->saldo_keluar,2,',','.');
                        echo $hasil_rupiah; ?><?php else: ?>
                        <?php $hasil_rupiah = "Rp " . number_format('0',2,',','.');
                        echo $hasil_rupiah; ?>	
                        <?php endif;?></div>
                                ...
                                <div class="col-auto">
                                <a href="#"><i class="fa fa-money fa-2x text-gray-000"></i>   <i class=" fa fa-arrow-circle-up fa-2x text-gray-000" style="color:red;"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
    ...
    <input type="text" name="createdtime" hidden placeholder="Masukkan Nama Department" autocomplete="off" value="<?php date_default_timezone_set('Asia/Jakarta');
                                  ...
                                  <select name="jenis_pety_cash" class="form-control" >
                    ...
                    <?php if (!empty ($_POST['jenis_pety_cash'])): ?>                     
  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="<?php echo $url_cetak_excel; ?>"><i class="fa fa-file-excel-o" style="color:green;"></i>&nbsp;&nbsp;Export Excel</a>
				...
				<div class="card shadow">
					...
					</div><a href="<?php echo base_url(); ?>user/petty_cash"><strong>Riwayat Isi Saldo</strong></a>  / <font color="blue"><strong>Semua Riwayat</strong></font></div>
					...
					<div class="card-body">
							...
							<table class="table table-bordered" id="dataable" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<td bgcolor="#DAE3E4" >Tgl Proses</td>
										<td bgcolor="#DAE3E4" width="80">Id Transaksi</td>
										<td bgcolor="#DAE3E4">Saldo Sebelum</td>
										<td bgcolor="#DAE3E4">Nominal Transaksi</td>
										<td bgcolor="#DAE3E4">Status</td>
										<td bgcolor="#DAE3E4" width="80">Tgl Transaksi</td>
										<td bgcolor="#DAE3E4">Keterangan</td>
										
									</tr>
								</thead>
								<tbody>
									<?php foreach ($petty_cash_riwayat as $mdl): ?>
										<tr>
											<td width="3"><?= $no++ ?></td>
											<td width="150"><?php echo date('Y-m-d H:i:s', strtotime($mdl->date_petty_cash)); ?></td>
											<td><?= $mdl->kode_pembayaran ?></td>
											<td>
												<?php $hasil_rupiah = "Rp " . number_format($mdl->saldo_before,2,',','.');
                        						echo $hasil_rupiah; ?>
											</td> 
											<td>
												<?php $hasil_rupiah = "Rp " . number_format($mdl->nominal_pembayaran,2,',','.');
                        						echo $hasil_rupiah; ?>
											</td>
											<td><?= $mdl->jenis_pety_cash ?></td> 
											<td><?= $mdl->tgl_transaksi_petty ?></td> 
											<td><?= $mdl->noted_pety_cash ?></td> 
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="dataable" width="100%" cellspacing="0">
								  ...
								  <?php foreach ($petty_cash_riwayat_count as $pay): ?>
                                                <tr>
                                            <td width="500" align="center">TOTAL NOMINAL TRANSAKSI</td>
