	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
           ...
           <div class="row">
                ...
                <?php else: ?>
             	 <a  data-toggle="modal" style="color:white" data-target="#right_modal_ceklist" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i>&nbsp;&nbsp;Anda Tidak Berhak Mengubah data ini </a>
            	<?php endif;?>
                    </div></h6>
                                ...
                                <div class="card-body">
									...
									<font size="2px"><?= $all_checklist->lokasi_penggunaan ?></font>
										...
										<div class="form-group col-md-8">:
									<font size="2px"><?php if(!empty($all_checklist->gambarrr)):?> <a href="<?php echo base_url(); ?>img/uploads/material/<?= $all_checklist->gambarrr ?>" target="blank" class="btn btn-secondary btn-sm">Gambar </span></a></font><?php endif;?></font>
										</div>
									<div class="form-group col-md-4">
										...
										<div class="form-group col-md-8">:
									<font size="2px"><?= $all_checklist->creat_by_mt.' - '.$all_checklist->creat_at_mt ?></font>
										</div>
																	<div class="form-group col-md-4">
							...
							<table class="table table-bordered" id="" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<td width="50"><font size="2px">Berkas</font></td>
						...
						<?php if($mdl->status_approved == 'Y' OR $mdl->status_approved == 'By Designer' ):?>
							...
							<td ><font size="2px">	<?php  echo $mdl->gambarr ?>	</font></td>
						...
						<?php if($mdl->status_approved == 'N'):?>
							...
							<td ><font size="2px"><?php if(!empty($mdl->gambarr)):?> <a href="<?php echo base_url(); ?>img/uploads/material/<?= $mdl->gambarr ?>" target="blank" class="btn btn-secondary btn-sm">Gambar </span></a></font><?php endif;?>  </td>
...
<form action="<?= base_url('user/leads/update_detail_material') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
 ...
 <input  type="text" maxlength="50" readonly name="lokasi_penggunaan_lama" placeholder="Masukkan Nama Lokasi" autocomplete="off" value="<?= $all_checklist->lokasi_penggunaan ?>"  class="form-control " hidden>
  <input  type="text" maxlength="50" readonly name="gambarrr" placeholder="Masukkan Nama Lokasi" autocomplete="off" value="<?= $all_checklist->gambarrr ?>"  class="form-control " hidden>
                          ...
                          <div class="form-group col-12">
                            ...
                            if (!empty($all_checklist->status_approved)) {
                                echo $all_checklist->status_approved == 'By Designer' ? 'selected' : '';
                            }
                            ?>>By Designer</option>
                            </select>
                                </div>
