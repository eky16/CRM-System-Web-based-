                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-header"> <strong><?php echo anchor('img/format_upload.xls");', 'Download Format');?> </strong></div>
                            <div class="card-body">
            <form method="post" action="<?= base_url('user/leads/importExcel') ?>" enctype="multipart/form-data">
