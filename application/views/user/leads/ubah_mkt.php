				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/leads/proses_ubah_mkt/' . $leads->id_lsp) ?>" id="form-tambah" method="POST">
								<div class="form-row">
						...
						<select id="select-state" placeholder="spv_manager" name="spv_manager" class="form-control" >           
							...
							<select id="select-state" placeholder="Status Project" name="status_project" class="form-control" onchange="showDiv('hidden_div', this)" required>           
			                 <option value="" >PILIH .....</option>
