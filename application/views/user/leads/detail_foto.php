...
<?php foreach ($all_foto as $mdl): ?>
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><a target="_blank" href="<?php echo base_url(); ?>img/uploads/<?= $mdl->foto ?>">   <img  src="<?php echo base_url(); ?>img/uploads/<?= $mdl->foto ?>" style="width:100%;height:150px;cursor:-webkit-grab; cursor: grab;" ></a>
          <div class="p-4">
