<tr class="row-keranjang">
	...
	<td class="hrg_brg"hidden>
		<?= $this->input->post('hrg_brg') * $this->input->post('jumlah') ?>
		<input type="hidden" name="harga_satuan_k_hidden[]" value="<?= $this->input->post('hrg_brg') ?>">
	</td>
		<td class="ket_pengeluaran">
		<?= strtoupper($this->input->post('ket_pengeluaran')) ?>
		<input type="hidden" name="ket_pengeluaran_hidden[]" value="<?= $this->input->post('ket_pengeluaran') ?>">
	</td>
	<td class="aksi">
