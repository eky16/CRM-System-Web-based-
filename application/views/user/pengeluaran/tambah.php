			...
			<div id="content" data-url="<?= base_url('user/barang') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('user/pengeluaran') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
				</div>
				<hr>
				<div class="row">
					<div class="col">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/barang/proses_tambah') ?>" id="form-tambah" method="POST">
									<h5>Data Admin</h5>
									<hr>
									<div class="form-row">
										...
										<div class="col-md-8">
											...
											<option value="">Pilih Barang</option>
												...
												<div class="form-group col-3" hidden>
													...
													<input type="number" name="hrg_brg" value="" class="form-control" readonly min='1'>
												</div>
		...
		$(document).ready(function(){
				...
				if($(this).val() == '') reset()
					...
					$.ajax({
						...
						success: function(data){
							...
							$('input[name="hrg_brg"]').val(data.hrg_brg)
							$('input[name="jumlah"]').val(1)
							$('input[name="satuan"]').val(data.Satuan)
							$('input[name="max_hidden"]').val(data.stok)
							$('input[name="jumlah"]').prop('readonly', false)
							$('input[name="hrg_brg"]').prop('readonly', false)
			...
			$(document).on('click', '#tambah', function(e){
				...
				const data_keranjang = {
					...
					ket_pengeluaran: $('textarea[name="ket_pengeluaran"]').val(),
			...
			$('button[type="submit"]').on('click', function(){
				...
				$('input[name="nama_barang"]').prop('disabled', true)
				$('input[name="nama_customer"]').prop('disabled', true)
			...
			function reset(){
				$('textarea[name="ket_pengeluaran"]').val('')
