...
<?php $dan_tanggl = date('Y-m-d', strtotime($_GET['dan_tanggal']));?>
  ...
  <table border="1">
      <TR >
       ...
       <th width="315" colspan="6"  align="center"><p align="center"><font size="13px"><strong>PENGELUARAN BARANG - <?php echo date('d F, Y', strtotime($_GET['tanggal']));?>  S/d <?php echo date('d F, Y', strtotime($_GET['dan_tanggal']));?>  </strong>&nbsp;</p></th>
  </TR>
