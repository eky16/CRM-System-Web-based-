		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('user/penerimaan') ?>">
				...
				<div class="clearfix">
					...
					<!--	<a href="<?= base_url('user/penerimaan/export_detail/' . $penerimaan->no_terima) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a> -->
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<td width="70"><strong>Satuan</strong></td>
									...
									<tbody>
										<?php foreach ($all_detail_terima as $detail_terima): ?>
											<tr>
												...
												<td><?= strtoupper($detail_terima->satuan) ?></td>
