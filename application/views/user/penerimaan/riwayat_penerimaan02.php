  ...
  <!--  <a class="dropdown-item" href="<?php echo $url_cetak; ?>"><i class="fa fa-file-pdf" style="color:red;"></i>&nbsp;&nbsp;Export Pdf</a> -->
    <a class="dropdown-item" href="<?php echo $url_cetak_excel; ?>"><i class="fa fa-file-excel-o" style="color:green;"></i>&nbsp;&nbsp;Export Excel</a>
				...
				<div class="card shadow">
					...
					</div><a href="<?php echo base_url(); ?>user/penerimaan"><strong>Penerimaan Barang</strong></a>  /<a href="<?php echo base_url(); ?>user/penerimaan/laporan_penerimaan"><strong>Laporan 01</strong></a>/ <a href="<?php echo base_url(); ?>user/penerimaan/laporan_penerimaan02"><font color="blue"><strong>Laporan 02</strong></font></a></div>
