				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/quotation/proses_tambah_srcLead') ?>"  id="from1" name="form" method="POST">

								<div class="form-row">
										<div class="form-group col-md-3">
											<label for="kode_barang"><strong>Kode Source Lead</strong></label>
											<input type="text" name="slug" placeholder="Masukkan Kode " autocomplete="off"  class="form-control" required value="<?php  $decode =  random_string('numeric', 5);
                                            $code = "SL".$decode; echo $code; ?>"  maxlength="8" readonly>
										</div>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="nama_barang"><strong>Nama Source Lead</strong></label>
											<input type="text" name="source" placeholder="Masukkan Nama Source Lead" autocomplete="off" id="id-nama" maxlength="50"  class="form-control" >
										</div>
