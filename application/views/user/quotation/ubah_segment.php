				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/customer/proses_ubah/' . $customer_id->id_cst) ?>" id="form-tambah" method="POST">
								<div class="form-row">
                                ...
                                ?>">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="nama_wilayah" id="wilayah" placeholder="Masukkan Nama Kota" autocomplete="off" maxlength="50" class="form-control" value="<?= $customer_id->nama_wilayah ?>" list="wilayah1" required >
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="nama_perusahaan" placeholder="Masukkan Nama Perusahaan" autocomplete="off"  maxlength="50"  class="form-control" value="<?= $customer_id->nama_perusahaan ?>">
										</div>

										<div class="form-group col-md-6">
                                            <label for="lead"><strong>Sumber Lead</strong></label>
                                            <input type="text" name="sumber_lead1" id="lead" placeholder="Masukkan Nama Kota" autocomplete="off" maxlength="50" class="form-control" value="<?= $customer_id->sumber_lead1 ?>" list="lead1" required >
