				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/quotation/proses_tambah_seg') ?>"  id="from1" name="form" method="POST">
								...
								<div class="form-row">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="segment" placeholder="Masukkan Nama Segment" autocomplete="off" id="id-nama" maxlength="50"  class="form-control" >
										</div>
