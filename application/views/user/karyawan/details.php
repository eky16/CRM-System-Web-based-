        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" data-url="<?= base_url('leads') ?>">
                ...
                <div class="clearfix">
                 ...
                 <!--   <a  data-toggle="modal" style="color:white" data-target="#person_doc<?php echo $emp->id; ?>" class="btn btn-primary btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;Doc</a>-->

                   <!-- <a href="<?= base_url('user/karyawan/export/'. $emp->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a> -->
        
                  <!--  <a href="<?= base_url('user/karyawan/ubah/' . $emp->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Ubah</a> -->

                   <!-- <a href="<?= base_url('user/karyawan/ubah_password/' . $emp->id) ?>" class="btn btn-info btn-sm ubah-password">
                    <i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Ubah Password
                    </a> -->
...
<form action="<?= base_url('user/karyawan/simpan_asset') ?>" id="form-tambah" method="POST">
...
<form action="<?= base_url('user/karyawan/simpan_berkas') ?>"  enctype="multipart/form-data" id="form-tambah" method="POST">
        <div class="modal-body">
                                 <!-- Content Column -->
                        <div class="col-lg-12 mb-4">
 ...
 <script>
    $(document).ready(function() {
        ...
        // Ketika tombol "Ubah Password" diklik
