    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" data-url="<?= base_url('mom/lihat_semua') ?>">
                ...
                <hr>
                    <form action="<?= base_url('user/karyawan/proses_update') ?>" enctype="multipart/form-data" id="form-tambah" method="POST" onsubmit="return validation(this)">
                    <!-- Content Row -->
                    <div class="row">
...
<hr>  
  ...
  <div class="card-body">
     <h4 class="small font-weight-bold">Data Kantor </h4>
                                        ...
                                        <input type="text" maxlength="20"  name="EmployeeID" placeholder="Masukkan Induk Karyawan" readonly autocomplete="off" value="<?= $emp->EmployeeID ?>"  class="form-control">
                                    </div>

                                <div class="form-group col-12">
                                            <label>Tanggal Bergabung</label>
                                 <input type="text" maxlength="20"  name="tgl_bergabung" placeholder="Masukkan Induk Karyawan" readonly autocomplete="off" value="<?= $emp->tgl_bergabung ?>"  class="form-control">
                                ...
                                <div class="form-group col-12">
                                            <label>Status</label>
                                 <input type="text" maxlength="20"  name="perjanjian_kerja" placeholder="perjanjian_kerja" readonly autocomplete="off" value="<?= $emp->perjanjian_kerja ?>"  class="form-control">
                                    </div>
                                
                <?php if ($emp->perjanjian_kerja == "KONTRAK" OR $emp->perjanjian_kerja == "PERCOBAAN" OR $emp->perjanjian_kerja == "HARIAN"): ?>      
                                <div class="form-group col-12">
                                            <label>Akhir Kerja</label>
                                 <input type="text" maxlength="20"  name="akhir_kerja" placeholder="Masukkan Induk Karyawan" readonly autocomplete="off" value="<?= $emp->akhir_kerja ?>"  class="form-control">
                                    </div><?php endif; ?> 
