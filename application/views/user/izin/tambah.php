        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" data-url="<?= base_url('asst') ?>">
                ...
                <div class="card shadow">
                    <div class="card-header"><strong>LIST KATEGORI  <a  href="#section1"><font color="blue">Read Me!</font></a></strong></div>
...
<?php if ($emp->email !== "cassa123@gmail.com"): ?>
   ...
   <?php else: ?>
                                       <a  data-toggle="modal" style="color:white" data-target="#person_adm<?php echo $izin->id_izin; ?>" class="btn btn-success btn-sm disabled"><i class="fa fa-edit"></i>&nbsp;&nbsp;Perbaiki Email Pribadi Anda</a>
                            <?php endif; ?>
                                    </td>                                       
                                    </tr>
<!-- modal update -->
...
<form action="<?= base_url('user/izin/proses_izin') ?>" enctype="multipart/form-data" id="formcek2" method="POST" ><?php endif; ?>
 <?php if ($izin->id_izin == 7): ?> 
<form action="<?= base_url('user/izin/proses_izin') ?>" enctype="multipart/form-data" id="formcek2" method="POST"  name="formcek2" onsubmit="return validateForm2()"> <?php endif; ?>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="form-group col-md-12">
                                            <label for="nama_barang"><strong>Kode </strong></label>
                                             <input onkeyup="this.value = this.value.toUpperCase()" type="text" maxlength="50" readonly name="kode_izin" placeholder="Masukkan Nama Lengkap" autocomplete="off" value="<?php  $code =  random_string('numeric', 5);
                                            echo "FPI".$code ?>"  class="form-control">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                            <label ><strong>Hak Cuti Tahun <?= $emp->tahun ?></strong></label>
                                             <input onkeyup="this.value = this.value.toUpperCase()" type="text" readonly maxlength="50" name="" placeholder="Masukkan Nama Lengkap" autocomplete="off" value="<?php echo $emp->jumlah-$emp->cuti .' / '. $emp->jumlah?>"  class="form-control">
                                </div><?php endif; ?>
                                <div class="form-group col-md-12">
                          ...
                          <?php if ($izin->id_izin == 7): ?> 
                                ...
                                <label ><strong> Surat Dokter </strong></label>
                                             <input type="file"   name="berkas" id="srt_dokter"  class="form-control" >
                                </div>
                             <script> 
        function validateForm2() {

            if (document.forms["formcek2"]["srt_dokter"].value == "") {
                alert("Surat Dokter Tidak Boleh Kosong");
                document.forms["formcek2"]["srt_dokter"].focus();
                return false;
            }
                                ...
                                <div class="form-group col-md-12">
                                            <label for="nama_barang"><strong>Atasan </strong></label>
                               <select  name="to[]" class="form-control" readonly>           
                      
                            <?php foreach ($atasan as $spv) : ?>
                                <option  value="<?php echo $spv->email ?>" <?php
                                if (!empty($emp->supervisorID)) {
                                    echo $spv->EmployeeID == $emp->supervisorID ? 'selected' : '';
                                }
                                ?> hidden><?php echo $spv->nama_karyawan  .' - '.$spv->email  ?></option>
                                    <?php endforeach; ?>
...
<input type="text" hidden name="EmployeeID" value="<?php echo $emp->EmployeeID; ?>"  class="form-control" >




  <input hidden onkeyup="this.value = this.value.toUpperCase()" type="text" maxlength="50" readonly name="subject" placeholder="browser"  autocomplete="off" value="<?= $izin->jenis ?>"  class="form-control">

                   <input type="text" name="createdby" placeholder="Masukkan Kode Barang" autocomplete="off"  class="form-control" required value="<?php echo $emp->nama_karyawan; ?>" maxlength="8" hidden>
