...
<!-- geolocation -->
<script src="<?= base_url('sb-admin') ?>/js/api.js"></script> 
<script src="<?= base_url('sb-admin') ?>/js/geo-min.js"></script> 
<script src="<?= base_url('sb-admin') ?>/js/geo-min2.js"></script> 
<script src="<?= base_url('sb-admin') ?>/js/geo-min3.js"></script> 
<script src="<?= base_url('sb-admin') ?>/js/geo-min4.js"></script>
<script src="<?= base_url('sb-admin') ?>/js/geo-min5.js"></script>
    <script> 
    $(document).ready(function() {
