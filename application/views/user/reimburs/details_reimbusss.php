...
<form action="<?= base_url('user/reimburs/save_proses_cek') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
                  ...
                  <div class="form-group col-md-12">
                        ...
                        <?php else: ?>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="form-group col-md-12">
                                            <label for="nama_barang">Tanggal Berkas </label>
                                             <input  type="date" maxlength="50" name="tgl_file_diterima" placeholder="Masukkan Nama Lengkap" autocomplete="off" value="<?php echo $v_department->tgl_file_diterima; ?>"  class="form-control">
                                </div>
                                <div class="form-group col-md-12">
       ...
       <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                            ...
                            <table class="table table-bordered"   width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <th class="col-sm-2" style="text-align: right; text-decoration: underline;"><?php
...
<form action="<?= base_url('user/reimburs/save_proses_pengecekan') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
...
<form action="<?= base_url('user/reimburs/save_proses_transfer') ?>" name="formcek2" onsubmit="return validateForm2()" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
    ...
    function showTgl(divId, element)
{
    document.getElementById(divId).style.display = element.value !== "Dll" ? 'block' : 'none' ;
      ...
      <input type="hidden" name="old_path" value="<?php
                                ...
                                ?>">
  <div class="image-upload-wrap">
    <input class="file-upload-input" type='file' name="berkas" onchange="readURL(this);" accept="image/*" id="foto2"  />
    <div class="drag-text">
      <h3>Drag and drop a file or select add Image</h3>
    </div>
  </div>
        ...
        <div class="form-group col-md-12">
         ...
         <?php endif; ?>
                                ...
                                <input type="text" id="datepicker" name="createdtime" value="<?php date_default_timezone_set('Asia/Jakarta');
                                        ...
                                        <hr>
        <?php       $harus_bayar = $total->total_reimburs;
                    $saldo_tersedia =$petty_cash->saldo;
        ?>
            <?php if($total->status_reimbus == 2) : ?>
           <div class="form-group col-md-12">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;Simpan</button>
    ...
    <script src="<?= base_url('sb-admin') ?>/vendor/datatables/dataTables.bootstrap4.min.js"></script>
      <script> 
        function validateForm2() {
            ...
            if (document.forms["formcek2"]["metod_pembayaran"].value == "") {
                alert("Metode Pembayaran Tidak Boleh Kosong");
                document.forms["formcek2"]["metod_pembayaran"].focus();
                return false;
            }
            if (document.forms["formcek2"]["tgl_transfer_real"].value == "") {
                alert("Tanggal Pembayaran Tidak Boleh Kosong");
                document.forms["formcek2"]["tgl_transfer_real"].focus();
                return false;
            }
        }
</script>
