				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/jadwal_pengiriman/proses_tambah_jadwal') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										
											<?php  $codek =  random_string('numeric', 5);
                                    $code = $codek ; ?>
		
									<input type="text" name="id_pengiriman" placeholder="Masukkan Kode Barang" autocomplete="off"  class="form-control" required value="<?php $txt = sprintf("%05s");
