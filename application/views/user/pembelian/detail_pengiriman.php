			...
			<div id="content" data-url="<?= base_url('pengeluaran') ?>">
				...
				<div class="card shadow">
					<div class="card-header"><strong><?= $title ?> - <?= $hd_pr->dibuat ?>, <?= $hd_pr->tgl_dibuat ?></strong>
					      <div class="float-right">
			<!--	<a href="<?= base_url('user/wo/export_pesanan_permintaan01/'. $hd_pr->id_pengiriman ) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Cetak Pdf </a> -->
					<a href="<?= base_url('user/wo/selesai') ?>" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;&nbsp;Riwayat Pengiriman </a>
