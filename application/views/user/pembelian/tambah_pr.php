			...
			<div id="content" data-url="<?= base_url('user/wo') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('user/wo/list_permintaan') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
				</div>
				<hr>
				<div class="row">
					<div class="col">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('user/wo/proses_tambah_pr') ?>"  enctype="multipart/form-data" id="form-tambah" method="POST">
									<h5>Sales Order</h5>
									<hr>
									<div class="form-row">
										...
										<div class="form-group col-6">
                                            ...
                                            <input type="text" name="status_packing"   id="status_packing" class=" form-control" list="status_packing1" autocomplete="off"  > 
												...
												<div class="form-group col-3">
													...
													<textarea type="text" name="merk" value="" class="form-control" > </textarea>
												</div>
												<div class="form-group col-3">
													<label>No.SO</label>

													<textarea type="text" name="no_so" value="" class="form-control" > </textarea>
												</div>
		...
		$(document).ready(function(){
			...
			$('#nama_barang').on('change', function(){
				...
				if($(this).val() == '') reset()
					...
					$.ajax({
						url: '<?php echo base_url()?>user/wo/get_all_barang',
						type: 'POST',
						dataType: 'json',
			...
			$(document).on('click', '#tambah', function(e){
				...
				const data_keranjang = {
					...
					merk: $('textarea[name="merk"]').val(),
					no_so: $('textarea[name="no_so"]').val(),
			...
			//	$('form :input').val('');
				...
				$('textarea[name=merk').val('');
				$('textarea[name=no_so').val('');
				...
				if(parseInt($('input[name="max_hidden"]').val()) <= parseInt(data_keranjang.quantity)) {
					...
					$.ajax({
						url: "<?php echo site_url('user/wo/keranjang_barang');?>",
						type: 'POST',
						data: data_keranjang,
						success: function(data){
			...
			$('button[type="submit"]').on('click', function(){
				...
				$('textarea[name="merk"]').prop('disabled', true)
				$('textarea[name="so"]').prop('disabled', true)
