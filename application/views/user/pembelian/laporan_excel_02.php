...
<?php $project = $_GET['project'];?>
  ...
  header("Content-Disposition: attachment; filename=PO Dalam Pengiriman.$project.xls");
  ...
  <table border="1">
      <TR >
       ...
       <th width="315" colspan="7"  align="center"><p align="center"><font size="13px"><strong> LAPORAN PESANAN PEMBELIAN DALAM PENGIRIMAN  - <?php echo $_GET['project'];?>   </strong>&nbsp;</p></th>
  </TR>
  ...
  <?php
    ...
    <tr>
                ...
                <td style="text-align: left; vertical-align: middle;">  <?php if ($row->taxable == 'true'):?>
                                        <?php
                                            $diskon = $row->total_harga_p - $row->cashDiscount_pajak;
                                            $hasil_pajak = $diskon + $row->total_harga_pajak ;
                                            $hasil_rupiah = 'Rp '. number_format($hasil_pajak,0,',','.');
                                            echo $hasil_rupiah; 
                                        ?>
                                         <?php endif;?>
                                        <?php if ($row->taxable == 'false'):?>
                                        <?php
                                            $diskon = $row->total_harga_np - $row->cashDiscount_np;
