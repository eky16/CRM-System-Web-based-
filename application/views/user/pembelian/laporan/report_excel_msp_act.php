...
<?php $jenis_tanggl = $_GET['jenis_tanggal']; ?>
  ...
  header("Content-Disposition: attachment; filename=TANGGAL SCAN PRODUKSI " .$tanggl." Sd ".$dan_tanggl." .xls");
  ...
  <table border="1">
      <TR >
       ...
       <th width="315" colspan="8"  align="center"><p align="center"><font size="13px"><strong>TANGGAL SCAN PRODUKSI  - <?php echo date('d F, Y', strtotime($_GET['tanggal']));?>  S/d <?php echo date('d F, Y', strtotime($_GET['dan_tanggal']));?>  </strong>&nbsp;</p></th>
  </TR>
  ...
  <br>
    <tr>
            ...
            <th  align="center" width="200"><font size="10px">Kategori</font></th>
 ...
 <tbody>
  ...
  foreach ($all_pr as $row): ?> 
    ...
    <tr>
      ...
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_cutting ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_punching ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_bending ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_welding ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_ps ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_fa ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->timescan_packing ?></td>
