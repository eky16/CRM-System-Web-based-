...
.text{
  ...
  header("Content-Disposition: attachment; filename=Kemajuan Pesanan Marketing  .xls");
  ?>
 ...
 <tbody>
  <?php $i=1;
    ...
    <tr>
                <td><?php echo $no++; ?></td>
                <td class="text"><?php echo $row->number_request; ?></td>
                <td class="text"><?php echo $row->no_so; ?></td>
                ...
                <td class="text">  <?php $status_pr = $row->status_qr  ?>
                        <?php if ($status_pr == "Batal" and $row->number_po != ""):?>
                          <span class="badge badge-primary"> Batal </span>
                        <?php endif;?>
