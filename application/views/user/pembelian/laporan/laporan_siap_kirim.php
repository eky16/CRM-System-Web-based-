 ...
 <tbody>
  <?php $i=1;
    ...
    <tr>
                ...
                <td class="text"><?php echo $row->itemUnitName; ?></td>
                ...
                <td class="text">  <?php $status_pr = $row->status_qr  ?>
                        ...
                        <td class="text"><?php echo $row->Qty_Delivery; ?></td>
                        <td class="text"><?php echo $row->Qty_Sisa; ?></td>
                        <td class="text"><?php echo $row->nol_tiga_bulan; ?></td>
                        <td class="text"><?php echo $row->tiga_enam_bulan; ?></td>
                        <td class="text"><?php echo $row->lebih_enam_bulan; ?></td>
