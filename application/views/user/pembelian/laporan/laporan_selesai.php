...
.text{
  ...
  <table border="1">
    <tr>
      ...
      <th>Supir</th>
      <th>Kenek</th>
      <th width="300">ket Kiriman</th>
      <th width="300">Tgl Produksi</th>
      <th width="300">Jenis Pesanan</th>
 ...
 <tbody>
  <?php $i=1;
    ...
    <tr>
                ...
                <td class="text"><?php echo $row->status_awal; ?></td>
                ...
                <td class="text">  <?php $status_pr = $row->status_qr  ?>
                        ...
                        <td class="text"><?php echo $row->qr_code; ?></td>
                        <td class="text"><?php echo $row->kode_pengiriman; ?></td>
                        <td class="text"><?php echo $row->tgl_kiriman; ?></td>

                        <td class="text"><?php echo $row->no_kendaraan; ?></td>
                        <td class="text"><?php echo $row->nama_supir; ?></td>               
                        <td class="text"><?php echo $row->nama_kenek; ?></td>
                <td class="text"><?php echo $row->catatan_kiriman; ?></td>
                <td class="text"><?php echo $row->tgl_produksi; ?></td>
                <td class="text"><?php echo $row->type_barang_pesanan; ?></td>
