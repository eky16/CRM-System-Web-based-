 ...
 <tbody>
  <?php $i=1;
    ...
    <tr>
                ...
                <td class="text"><?php echo $row->tgl_rencana_cutting; ?></td>
                <td class="text"><?php echo $row->tgl_rencana_punching; ?></td>
                <td class="text"><?php echo $row->tgl_rencana_bending; ?></td>
                <td class="text"><?php echo $row->tgl_rencana_welding; ?></td>
                <td class="text"><?php echo $row->tgl_rencana_ps; ?></td>
                <td class="text"><?php echo $row->tgl_rencana_fa; ?></td>
                <td class="text"><?php echo $row->tgl_rencana_packing; ?></td>             
