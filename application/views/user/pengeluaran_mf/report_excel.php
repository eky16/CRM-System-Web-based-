...
<?php $dan_tanggl = date('Y-m-d', strtotime($_GET['dan_tanggal']));?>
  ...
  header("Content-Disposition: attachment; filename=PENGELUARAN KOMPONEN MF " .$tanggl." Sd ".$dan_tanggl.".xls");
  ...
  <table border="1">
      <TR >
       ...
       <th width="315" colspan="8"  align="center"><p align="center"><font size="13px"><strong>PENGELUARAN KOMPONEN MF - <?php echo date('d F, Y', strtotime($_GET['tanggal']));?>  S/d <?php echo date('d F, Y', strtotime($_GET['dan_tanggal']));?>  </strong>&nbsp;</p></th>
  </TR>
  ...
  <br>
    <tr>
            ...
            <th  align="center" width="200"><font size="10px">No Keluar</font></th>
            <th align="center" width="250"><font size="10px">Customer</font></th>
            ...
            <th  align="center" width="200"><font size="10px">Admin</font></th>
            <th  align="center" width="100"><font size="10px">Waktu</font></th>
 ...
 <tbody>
  ...
  foreach ($pembayaran as $row): ?> 
    <tr>
      ...
      <td  class="text" style="text-align: left; vertical-align: middle;"><?php echo date('Y-m-d', strtotime($row->tgl_keluar)); ?></td>
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->no_keluar_mf ?></td>

      <td class="text" align="left"><?= $row->nama_customer ?></td>
      <td style="text-align: left; vertical-align: middle;">
        <?= $row->nama_barang_mf ?>                         
      </td>
      <td style="text-align: left; vertical-align: middle;">
        <?= $row->jumlah_mf ?> - <?= $row->Satuan_mf ?>
      ...
      <td style="text-align: left; vertical-align: middle;"><?= $row->ket_keluar_mf ?> </td>
      </td> <!-- end kredit -->
      <td class="text" style="text-align: left; vertical-align: middle;"><?= $row->nama_petugas ?></td>
      <td class="text" align="left"><?= $row->tgl_keluar ?>  <?= $row->jam_keluar ?></td>
