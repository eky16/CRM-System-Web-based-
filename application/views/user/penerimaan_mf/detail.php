		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('user/penerimaan_mf') ?>">
				...
				<div class="clearfix">
					...
					<!--	<a href="<?= base_url('user/penerimaan_mf/export_detail/' . $penerimaan->no_terima) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a> -->
				...
				<div class="card shadow">
					<div class="card-header"><strong><?= $title ?> - <?= $penerimaan_mf->no_terima ?></strong></div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<td width="350" class="color-Brown" ><strong>Nama Barang</strong></td>
											<td width="70" class="color-Brown" ><strong>Jumlah</strong></td>
											...
											<td class="color-Brown"><strong>Keterangan</strong></td>
										</tr>
									</thead>
									<tbody>
										<?php foreach ($all_detail_terima_mf as $detail_terima_mf): ?>
											<tr>
												<td><?= $no++ ?></td>
												<td><?= $detail_terima_mf->nama_barang_mf ?></td>
												<td><?= $detail_terima_mf->jumlah_mf ?>-<?= strtoupper($detail_terima_mf->Satuan_mf) ?> </td>
                                                
												<td><?= $detail_terima_mf->ttpas ?> </td>
												<td><?= $detail_terima_mf->ttpad ?> </td>
												<td><?= $detail_terima_mf->smpgs ?> </td>
												<td><?= $detail_terima_mf->smpgd ?> </td>
												<td><?= $detail_terima_mf->blkgs ?> </td>
												<td><?= $detail_terima_mf->blkgd ?> </td>
												<td><?= $detail_terima_mf->rack ?> </td>
												<td><?= $detail_terima_mf->box ?> </td>
												<td><?= $detail_terima_mf->chss_stat ?> </td>
												<td><?= $detail_terima_mf->chss_din ?> </td>
												<td><?= $detail_terima_mf->chs_d_din ?> </td>
												<td><?= $detail_terima_mf->ttpchs_s ?> </td>
												<td><?= $detail_terima_mf->ttpchs_d ?> </td>
												<td><?= $detail_terima_mf->cntls ?> </td>
												<td><?= $detail_terima_mf->cntld ?> </td>
												<td><?= $detail_terima_mf->pngmn ?> </td>
												<td><?= $detail_terima_mf->rell ?> </td>
												<td><?= $detail_terima_mf->samb_rell ?> </td>
												
												<td><?= $detail_terima_mf->ket_penerimaan_mf ?></td>
											</tr>
										<?php endforeach ?>
									</tbody>
								</table>
