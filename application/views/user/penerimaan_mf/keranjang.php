<tr class="row-keranjang">
	...
	<td class="Satuan_mf">
		<?= strtoupper($this->input->post('Satuan_mf')) ?>
	...
	<td class="samb_rell">
		...
		<td class="ket_penerimaan_mf">
		<?= strtoupper($this->input->post('ket_penerimaan_mf')) ?>
		<input type="hidden" name="ket_penerimaan_mf_hidden[]" value="<?= $this->input->post('ket_penerimaan_mf') ?>">
	</td>
	<td class="aksi">
