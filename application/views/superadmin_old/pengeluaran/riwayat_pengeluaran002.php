                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-header"><strong>Proyek</strong></div>
                            <div class="card-body">
                                <form action="<?= base_url('barang/laporan_pengeluaran02' ) ?>" id="form-tambah" method="POST">
                                    <div class="form-row">
...
?> 
                            ...
                            if (!empty($project)) {
                                echo $project == $prk->projectNo ? 'selected' : '';
                            }
                            ?>
  ...
  <!--  <a class="dropdown-item" href="<?php echo $url_cetak; ?>"><i class="fa fa-file-pdf" style="color:red;"></i>&nbsp;&nbsp;Export Pdf</a> -->
    <a class="dropdown-item" href="<?php echo $url_cetak_excel; ?>"><i class="fa fa-file-excel-o" style="color:green;"></i>&nbsp;&nbsp;Export Excel </a>
				...
				<div class="card shadow">
					...
					</div><a href="<?php echo base_url(); ?>barang/list_pengeluaran"><strong>Pengeluaran Barang</strong></a>  / <a href="<?php echo base_url(); ?>barang/laporan_pengeluaran"><strong>Laporan I</strong></a>/ <a href="<?php echo base_url(); ?>barang/laporan_pengeluaran02"><font color="blue"><strong>Laporan II</strong></font></a></div>
							...
							<table class="table table-bordered" id="dataable" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<td bgcolor="#DAE3E4" width="70">Tgl</td>
								...
								<tbody>
									<?php foreach ($pengeluaran as $mdl): ?>
										<tr>
											<td width="3"><?= $no++ ?></td>
											<td ><?php echo date('Y-m-d', strtotime($mdl->tgl_keluar)); ?></td>
											<td><?= $mdl->no_keluar ?></td>
											<td><?= $mdl->project_name ?>
											</td> 
											<td><?= $mdl->nama_barang ?></td>
											<td align="left"><?= $mdl->jumlah ?> - <?= $mdl->satuan ?></td> 
											<td><?php 
                                            $hasil_rupiah = "Rp " . number_format($mdl->harga_satuan_k,0,',','.');
                                ...
                                <?php foreach ($grand_total_barang as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">  <b>
                                         <?php
                                         $hasil_rupiah = "Rp " . number_format($row->total_harga_barang,0,',','.');
                                         echo $hasil_rupiah; ?>
                                     </b></td>                                
                                 </tr>
