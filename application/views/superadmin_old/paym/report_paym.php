                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                            <label for="nama_barang">ID </label>
                                             ...
                                             <input onkeyup="this.value = this.value.toUpperCase()" type="text" maxlength="50" readonly name="status_approval" placeholder="Masukkan Nama Lengkap" hidden autocomplete="off" value="<?php echo $pay->status_approval ; ?>"  class="form-control">
                                </div>
                                                <div class="form-group col-md-12">
