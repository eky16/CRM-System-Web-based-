...
<body id="page-top">
    ...
    <div class="dropdown-menu">
     ...
     <div class="row">
          ...
          <a target="_blank" href="<?= base_url('leads/rab/'.$all_leads->id_proyek_accurate) ?>" class="btn btn-info btn-sm"><i class="fa fa-money"></i>&nbsp;&nbsp;RAB </a>
				</div>
                          ...
                          <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                 <a target="blank" href="<?= base_url('pembelian/laporan_02/'. $all_leads->id_proyek_accurate ) ?>"> <div class="h6 mb-0  font-weight-bold text-success text-uppercase mb-1"> TOTAL PENGELUARAN PESANAN PEMBELIAN</div></a>
                        <a target="blank" href="<?= base_url('pembelian/laporan_02/'. $all_leads->id_proyek_accurate ) ?>">           <div class="h3 mb-0 font-weight-bold text-gray-800"> 
...
<div class="collapse col-xl-3 col-md-6 mb-4" id="collapseExample">
                          <div class="card border-bottom-primary shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <a target="_blank" href="<?= base_url('pembelian/sub_laporan_furniture/'. $all_leads->id_proyek_accurate ) ?>">
...
<div class="collapse col-xl-3 col-md-6 mb-4" id="collapseExample">
                          <div class="card border-bottom-primary shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <a target="_blank" href="<?= base_url('pembelian/sub_laporan_me/'. $all_leads->id_proyek_accurate ) ?>">
               ...
               <div class="col-xl-6 col-md-6 mb-4">
                          <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <a target="_blank" href="<?= base_url('pembelian/laporan_03/'. $all_leads->id_proyek_accurate ) ?>">
...
<div class="collapse col-xl-3 col-md-6 mb-4" id="collapseExample">
                          <div class="card border-bottom-primary shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <a target="_blank" href="<?= base_url('pembelian/sub_laporan_sipil/'. $all_leads->id_proyek_accurate ) ?>">
...
<div class="collapse col-xl-3 col-md-6 mb-4" id="collapseExample">
                          <div class="card border-bottom-primary shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <a target="_blank" href="<?= base_url('pembelian/sub_laporan_dll/'. $all_leads->id_proyek_accurate ) ?>">
...
<div class="col-xl-6 col-md-6 mb-4">
                          <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                 <a target="blank" href="<?= base_url('barang/laporan_pengeluaran002/'. $all_leads->id_proyek_accurate ) ?>"> <div class="h6 mb-0  font-weight-bold text-info text-uppercase mb-1"> TOTAL PENGELUARAN BARANG</div></a>
                        <a target="blank" href="<?= base_url('barang/laporan_pengeluaran002/'. $all_leads->id_proyek_accurate ) ?>">           <div class="h3 mb-0 font-weight-bold text-gray-800"> 
  <?php foreach ($grand_total_barang as $row): ?>
     ...
     <?php endforeach ?>                        
                                ...
                                <div class="col-auto">
                                <a target="blank" href="<?= base_url('pembelian/laporan_02/'. $all_leads->id_proyek_accurate ) ?>">   <i class="fa fa-briefcase fa-2x text-gray-000"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="collapse col-xl-6 col-md-6 mb-4" id="collapseExample">
                          <div class="card border-bottom-primary shadow h-100 py-2">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <a target="_blank" href="<?= base_url('pembelian/sub_laporan_preliminaries/'. $all_leads->id_proyek_accurate ) ?>">
                                  <div class="h6 mb-0  font-weight-bold text-primary text-uppercase mb-1"> PRELIMINARIES</div></a>
                                 <a target="_blank" href="<?= base_url('pembelian/sub_laporan_preliminaries/'. $all_leads->id_proyek_accurate ) ?>">
                                  <div class="h3 mb-0 font-weight-bold text-gray-800"> 
  <?php foreach ($grand_total_pesanan_preliminaries as $row): ?>
                      
                    <?php
                    $total_preliminaries    = $row->harga_total_preliminaries;
                    $hasil_preliminaries = "Rp " . number_format($row->harga_total_preliminaries,0,',','.');
                    echo $hasil_preliminaries; ?>
     ...
     <?php endforeach ?>                        
                          ...
                          <div class="card border-left-success shadow h-100 py-2">
                            ...
                            <a target="blank"  href="<?= base_url('reimburs/laporan_001/'. $all_leads->id_lsp ) ?>"> TOTAL REIMBURSEMENT</a></div>
                         <a target="blank" href="<?= base_url('reimburs/laporan_001/'. $all_leads->id_lsp ) ?>"> 
                                  <div class="h3 mb-0 font-weight-bold text-gray-800">
                            ...
                            <div class="card shadow mb-4">
                             ...
                             echo '<a class="btn btn-outline-success btn-sm" style="color:black"> PENDING</a>';
                                     ...
                                     elseif ($all_leads->status_project == 'RETENSI'){
                                        ...
                                        echo '<a class="btn btn-warning btn-sm" style="color:white">RETENSI</a>';
                                    }
                                    else {
...
<div class="card shadow" id="section1">
				<div class="card-header py-3">
  						  	<div class="float-right"> 
  						  		 <a  href="<?php echo base_url('mod_kerja/tambah');?>" target="blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Task</a>
                    </div>        
...
?> <font size="1px">(<?php echo $mdl->department ?>)</font>
                                      ...
                                      <?php elseif($mdl->status_modul == 1) : ?>
                                       ...
                                       <?php endif; ?></td> </font></td>
											<td align="center"><a target="blank" href="<?= base_url('mod_kerja/detail/' . $mdl->kode_modul) ?>" class="btn btn-primary btn-sm">Lihat</a></td>
...
<div class="card shadow" id="section2">
                  ...
                  <a  href="<?php echo base_url('mom/tambah');?>" target="blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah M O M</a>
...
<span class="badge badge-success">GOAL</span>
                                       <?php endif; ?></td>
											...
											<td align="center"><a href="<?= base_url('mom/detail/' . $mdl->id) ?> "target="blank" class="btn btn-primary btn-sm">Lihat</a></td>
										</tr>
...
?> <font size="1px">(<?php echo $mdl->department ?>)</font>
										...
										$hasil = $total / $bagi ;
											...
											<td align="center"><a href="<?= base_url('leads/detail_foto/' . $mdl->id_lsp .'/'. $mdl->tgl_upload) ?>" target="blank" class="btn btn-primary btn-sm">Lihat</a></td>
										</tr>
									<?php endforeach ?>
								</tbody>
							</table>
...
?> <font size="1">(<?php echo $mdl->department ?>)</font>
											...
											<td align="center"><a href="<?= base_url('leads/detail_issue/' . $mdl->kode_issue) ?>" target="blank" class="btn btn-primary btn-sm">Lihat  <span class="badge badge-danger badge-counter "><?php echo $mdl->hitung ?></span></a></td>
										</tr>
...
<span class="badge badge-success">Finish</span>
							<?php endif;?>
											...
											<td align="center"><a href="<?= base_url('leads/detail_checklist/' . $mdl->kode_ceklist) ?>" target="blank" class="btn btn-primary btn-sm">Lihat  <span class="badge badge-danger badge-counter "><?php echo $mdl->hitung ?></span></a></td>
										</tr>
									<?php endforeach ?><?php endif;?>
								</tbody>
							</table>
								...
								<thead>
									<tr>
										...
										<td><font size="2px">File</font></td>
										 ...
										 <th width="5%"><button type="button" name="delete_all" id="delete_all" class="btn btn-danger btn-xs"><font size="2px">Delete</font></button></th>
...
<?php endif; ?>
											 ...
											 <td align="center"><input type="checkbox" class="delete_checkbox_daily" value="'.$mdl->id_stts_log.'" /></td>
...
<form action="<?= base_url('leads/update_laporan_status_log') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
...
<form action="<?= base_url('leads/save_laporan_status_log') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
...
<form action="<?= base_url('leads/create_issue') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                            <label for="nama_barang">Judul Issue </label>
                                             <input  type="text"   name="judul_issue" placeholder="Masukkan Nama Lengkap" autocomplete="off" value=""  class="form-control" required>
                                </div>
										<div class="form-group col-12">
											<label>Keterangan</label>
 ...
 <script type="text/javascript">
        ...
        $("#addRow").click(function () {
            ...
            html += '<textarea   name="issue[]"  class="form-control m-input" placeholder="issue" autocomplete="off"></textarea>';
...
<form action="<?= base_url('leads/create_checklist') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
...
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>leads/delete_all_daily",
    method:"POST",
