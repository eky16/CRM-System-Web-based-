			...
			<div id="content" data-url="<?= base_url('asst') ?>">
				...
				<div class="card shadow">
					<div class="card-header"><strong>Proyek - <?= $leads->nama_project ?></strong>			<div class="float-right">
							<a href="<?= base_url('dashboard') ?>" class="btn btn-primary btn-sm"><i class="fa fa-home"></i> Dashboard</a> 
							<a href="<?= base_url('leads/detail/'.$leads->id_lsp) ?>" class="btn btn-info btn-sm"><i class="fa fa-user"></i> Profil Proyek</a>
							...
							<a href="<?= base_url('leads/upload_bq') ?>" class="btn btn-info btn-sm"><i class="fa fa-upload"></i> Upload</a>
						</div>
				</div>
...
<div class="modal-dialog modal-large" role="document">
	<div class="modal-content">
		...
		<form action="<?= base_url('leads/update_rap') ?>" enctype="multipart/form-data"  method="POST">
...
<div class="modal-dialog modal-large" role="document">
	<div class="modal-content">
		...
		<form action="<?= base_url('leads/hapus_rab_ByID') ?>" enctype="multipart/form-data"  method="POST" id="hapus_item">
			<div class="modal-body">
				<!-- Content Column -->
...
<div class="modal-dialog modal-large" role="document">
	<div class="modal-content">
		...
		<form action="<?= base_url('leads/simpan_rap') ?>" enctype="multipart/form-data"  method="POST">
			<div class="modal-body">
				<!-- Content Column -->
