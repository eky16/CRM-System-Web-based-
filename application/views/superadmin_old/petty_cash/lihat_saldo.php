		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('asst') ?>">
				...
				<a  data-toggle="modal" style="color:white" data-target="#right_modal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Isi Ulang Saldo</a>
					...
					</div><font color="blue"><strong>Riwayat Saldo</strong></font>  / <a  href="<?php echo base_url(); ?>petty_cash/riwayat"><strong>Semua Riwayat</strong></a></div>
...
<form action="<?= base_url('petty_cash/save_transaksi_pety') ?>" enctype="multipart/form-data" id="form-tambah" method="POST">
      <div class="modal-body">
                                 <!-- Content Column -->
