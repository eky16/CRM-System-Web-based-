				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('mom/save_mom') ?>" id="form-tambah" method="POST" enctype="multipart/form-data">

								<div class="form-row">
										<div class="form-group col-md-3">
											<label for="kode_barang"><strong>KODE M O M</strong></label>
											<input type="text" name="id_mom" placeholder="Masukkan Kode " autocomplete="off"  class="form-control" required value="<?php echo $kode_momproject; ?>" maxlength="8" readonly >
										</div>
