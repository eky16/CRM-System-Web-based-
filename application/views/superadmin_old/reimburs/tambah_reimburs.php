                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
    <form action="<?= base_url('reimburs/proses') ?>" enctype="multipart/form-data" method="POST">
                                    <div class="form-row">
 ...
 $("select[id=combo_jenis]").on("change", function() { 
  ...
  $("select[id=combo_jenis]").trigger("change");
        ...
        $("#addRow").click(function () {
            ...
            html += '<div id="inputFormRow">';
            html += '<div class="input-group mb-3">';
            html += '<input onkeypress="return hanyaAngka(event)" type="text" name="nominal[]"  placeholder="Hanya Angka Tidak boleh ada titik & koma" autocomplete="off" value=""  class="form-control" required>';
