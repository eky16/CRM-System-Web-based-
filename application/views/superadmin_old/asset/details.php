		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('leads') ?>">
				...
				<div class="clearfix">
					...
					<a href="<?= base_url('asset/tambah') ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Asset Baru </a> 
					<a href="<?= base_url('asset/ubah/' . $asst-> 	id_asset) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp;&nbsp;Ubah</a>
						<?php endif ?>
  ...
  onclick="document.getElementById('modal01').style.display='block'">
    ...
    <div class="w3-modal-content w3-animate-zoom">
      <img src="<?php echo base_url(); ?>img/uploads/foto_asset/<?= $asst->gambar_asset ?>" style="width:100%">
                   		...
                   		<div class="form-group col-md-4">
											<label ><strong>Jenis Asset</strong>
											</label>
										</div>
										<div class="form-group col-md-5">:
											<?= $asst->jenis_asset ?>
						  ...
						  <?php if ($asst->jenis_asset == "Asset Bergerak"): ?>  
							        <div class="form-group col-md-4">
											<label ><strong>Masa Berlaku</strong>
											</label>
										</div>
										<div class="form-group col-md-5">:
											<?php 
                                            $start_date = new DateTime($asst->tgl_pajak);
                            		...
                            		<div class="form-group col-md-4">
										...
										<?php if(!empty($asst->nama_karyawan)):?>
										<div class="form-group col-md-4">
											<label ><strong>Karyawan</strong>
											</label>
										</div>
										<div class="form-group col-md-5">:
											<?= $asst->nama_karyawan ?>
