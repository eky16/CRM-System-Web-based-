...
<body id="page-top">
    <div id="wrapper">
        ...
        <a  data-toggle="modal" style="color:white" data-target="#detail_task_chat<?php echo $v_department->kode_create ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Message</a>
 
<div id="detail_task_chat<?php echo $v_department->kode_create ?>" class="modal fade">
...
?>">                                      
 <input type="" hidden name="kode_modul"  value="<?php echo $kode_modul ?>">
                                             <input type=""  name="kode_modul_chat"  value="<?= basename($_SERVER['REQUEST_URI'], '?' . $_SERVER['QUERY_STRING']); ?>">
                                </div>
                                        <div class="form-group col-md-12">
                                       <?php if($this->session->login['nama'] != $pembuat ): ?>     
                                             <textarea class="form-control"   name="kepada3"  placeholder="Enter message..." ><?= $pembuat;?></textarea>
                                         <?php endif;?>
                                            <textarea class="form-control"   name="kepada"  placeholder="Enter message..." ><?= $penerima;?></textarea>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-12">
                                         <button  type="button" id="simpan_chat_detail" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;Simpan</button>
...
$(document).ready(function(){
    ...
    $('#simpan_chat_detail').on('click', function(){
         $('#detail_task_chat<?php echo $v_department->kode_create ?>').modal('hide');
  ...
  $('#detail_task_chat<?php echo $v_department->kode_create ?> form')[0].reset();
 })
});
